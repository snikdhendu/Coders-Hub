              ...
              >
                <div className="flex flex-col gap-5 p-3">
                  ...
                  <button
                    ...
                    className="bg-white dark:border-b-slate-700 dark:bg-background border border-black text-gray-800 hover:bg-gray-200 rounded-md flex items-center space-x-2 dark:text-white"
                  >
                    <input
                      className="check"
                      type="checkbox"
                    ...
                    <svg
                      viewBox="0 0 512 512"
                      xmlns="http://www.w3.org/2000/svg"
                      className={`icon ${likeStates[project._id]?.isLiked ? 'active' : 'inactive'}`}
                      >
