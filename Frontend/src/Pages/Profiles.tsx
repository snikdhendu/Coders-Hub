...
const Profiles = () => {
    const { data, loading, error } = useQuery<{ getAllUsers: ProjectType[] }>(getAllUsers);
    const [searchQuery, setSearchQuery] = useState<string>("");
    const [profiles, setProfiles] = useState<ProjectType[]>([]);
    console.log(data);
                            ...
                            <div className="container">
                                <div className="row">
                                    <div className="col-12 col-sm-6 col-md-4 col-lg-3 ">
                                        <div className="our-team bg-white border-2 dark:border-b-slate-700 dark:bg-background text-textmain font-bold font-royal4 p-8 rounded-lg shadow-lg cursor-pointer w-4/5">
                                            <div className="picture">
                                                <img className="img-fluid" src={profiles.profileUrl} />
                                            </div>
