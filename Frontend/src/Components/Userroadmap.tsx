...
const Userroadmap= () => {
  ...
  return (
    <div style={{ width: '100vw', height: '100vh', position: 'relative', backgroundImage: 'url("../public/pexels-danielabsi-952670.jpg")', backgroundSize: 'cover' }}>
      {!isLocked && (
        <button onClick={addCustomNode} style={{ position: 'absolute', zIndex: 10, top: 10, left: 10 }}>
          Add Node
        </button>
      )}
      ...
      <button onClick={onLocked} style={{ position: 'absolute', top: 10, zIndex: 10, right: 10 }}>
